...
from myapp.users.forms import LoginForm, RegisterForm, RequestResetForm, ResetPasswordForm
...
def SendResetEmail(user):
    ...
    msg = Message('Password Reset Request', sender='xtraload@gmail.com', recipients=[user.email])
